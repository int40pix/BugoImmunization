        ...
        <SidebarContext.Provider value={contextValue}>
            <TooltipProvider delayDuration={0}>
                <div
                    ...
                    className={cn('group/sidebar-wrapper flex min-h-svh w-full max-w-full min-w-0 overflow-x-clip has-data-[variant=inset]:bg-sidebar', className)}
                    ref={ref}
                    {...props}
                >
                    {children}
...
const SidebarInset = React.forwardRef<HTMLDivElement, React.ComponentProps<'main'>>(({ className, ...props }, ref) => {
    return (
        <main
            ref={ref}
            className={cn(
                'relative flex min-h-svh flex-1 flex-col bg-background min-w-0 max-w-full overflow-x-clip',
